                ...
                <div className="personal-content">
                    ...
                    <div className="personal-content__items">
                        <div className="input__item">
                            ...
                            <div className="input__container">
                                <input placeholder="__.__.____" name="birthday" type="date"/>
                            </div>
                        </div>
