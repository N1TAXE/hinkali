                    ...
                    <React.Fragment>
                        <div className="authorized__content">
                            ...
                            <div className="authorized__content-text">
                                Чтобы совершить свой первый заказ, выберете себе что‑нибудь вкусное на главной странице
                            </div>
                        </div>
                        <div className="authorized__buttons">
                            <NavLink to={CATALOGUE_ROUTE} className="btn btn-md btn-red">На главную</NavLink>
                            <button onClick={() => setOrders('have')} className="btn btn-md btn-red">Тестовый список</button>
